...
camara *camaraNormal, *perfil, *planta, *alzado, *camaraActual;
...
cout<<-Observer_distance<<" "<<Observer_angle_x<<" "<<Observer_angle_y<<endl;
if(d)
...
{
// camaraActual->Proyseccion();
camaraActual->change_observer(1,1,1);
clear_window();
draw_axis();
draw_objects(); 
glutSwapBuffers(); 
...
switch (Tecla1){
	case GLUT_KEY_LEFT:/*Observer_angle_y--;*/ camaraActual->setObserver_angle_y(camaraActual->getObserver_angle_y()+1);break;
	case GLUT_KEY_RIGHT:/*Observer_angle_y++;*/camaraActual->setObserver_angle_y(camaraActual->getObserver_angle_y()-1);break;
	case GLUT_KEY_UP:/*Observer_angle_x--;*/camaraActual->setObserver_angle_x(camaraActual->getObserver_angle_x()+1);break;
	case GLUT_KEY_DOWN:/*Observer_angle_x++;*/camaraActual->setObserver_angle_x(camaraActual->getObserver_angle_x()-1);break;
	case GLUT_KEY_PAGE_UP:/*Observer_distance*=1.2;*/camaraActual->setObserver_distance(camaraActual->getObserver_distance()*1.2);break;
	case GLUT_KEY_PAGE_DOWN:/*Observer_distance/=1.2;*/camaraActual->setObserver_distance(camaraActual->getObserver_distance()/1.2);break;
	case GLUT_KEY_F1:camaraActual=camaraNormal;break;
	case GLUT_KEY_F2:camaraActual=perfil;break;
	}
glutPostRedisplay();
}
...
{
    camaraNormal = new camara(1,-Window_width,Window_width,-Window_height,Window_height,Front_plane,Back_plane);
    
    perfil = new camara(0,-5.0,5.0,-5.0,5.0,-15.0,15.0);
    
//     camaraNormal->Proyeccion();
    camaraActual=camaraNormal;
